...
def test_event_study_summary_rejects_malformed_event_indexes():
    labels = add_forward_returns([100, 110], [1])
...
def test_multi_horizon_event_study_summary_rejects_malformed_event_indexes():
    labels = add_forward_returns([100, 110], [1])
...
def test_validated_event_study_report_rejects_malformed_event_indexes():
    labels = add_forward_returns([100, 110], [1])
